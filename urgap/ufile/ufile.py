...
class UFile:
    ...
    def init_io_class(self) -> urgap.UFile.io:
        ...
        if scheme not in available_io_classes:
            msg = (
                f"IO class {scheme} cannot be imported due to missing dependencies. "
        ...
        if scheme in (
            ...
            io = available_io_classes[scheme](uuri=self.uuri)
        else:
            msg = f"Cannot initialize driver for unknown {scheme}"
            raise OSError(msg)
        return io
