...
class IOAzureBlobStorage(UIOBase):
    ...
    def get_remote_tags(self) -> dict | None:
        ...
        Returns:
            The dictionary of tags (metadata) if the object exists, otherwise None.
        """
        if self.remote_object_exists():
            return self.blob.get_blob_properties()["metadata"]
        return None
