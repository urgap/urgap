...
class UUri:
    ...
    def check_uri_scheme_exists(self) -> None:
        ...
        if self.scheme not in (
            ...
            msg = f"Scheme {self.scheme} not supported"
    ...
    def host(self) -> str | None:
        """Get the host."""
        if self.scheme == "smb" or "libcloud" in self.scheme:
    ...
    @property
    def libcloud_project_folder(self) -> Path | None:
        """Get the project_folder."""
        if "libcloud" in self.scheme:
            return self.get_libcloud_project_folder()
        return None

    def get_libcloud_project_folder(self) -> Path:
        """Get the project_folder."""
        return urgap.project_folder
