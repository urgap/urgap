        ...
        return Prompt(
            ...
            messages=[
                base.AssistantMessage(
                    content={
                        "type": "text",
                        "text": f"gcs-libcloud://{project_id}/{bucket}",
                    },
                ),
            ],
            arguments=[
    ...
    async def urun_default_dict() -> Prompt:
        ...
        tool_docs = """
...

                {
                    ...
                    "unode_parameters": {
                        "storage_base_uri": str|None,   // Optional: Storage base URI for output files
                                                        // Example: 'gcs-libcloud://{project_id}/{bucket}'
                ...
                Example usage:
                {
                    ...
                    "unode_parameters": {
                        "force": true,
                        "storage_base_uri": "gcs-libcloud://<my-project-id>/<my-container>",
                    }
                }
            """
        ...
        "unode_parameters": {        // Parameters specific to the UNode
                ...
                "storage_base_uri": str|None,   // Optional: Storage base URI for output files
                                                // Example: "gcs-libcloud://<project>/<bucket>"
