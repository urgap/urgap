...
class SamtoolsIndex_1_7_1(urgap.unode.UNodeBase):
    """Urgap wrapper for samtools index."""

    META_INFO = {
        "name": "samtools_index_bam_1_7_1",
        "version": "1.7.1",
        ...
        "utranslation_style": "samtools_index_bam_style_1",
        "engine": {
            "darwin": {
                "arm64": {
                    "exe": "samtools",
    ...
    def __init__(self, *args: str, **kwargs: str) -> None:
        """Initialize SamtoolsIndex_1_7_1 class."""
    ...
    def preflight(
        ...
        """Preflight routine for samtools_index_bam_1_7_1 wrapper.
    ...
    def postflight(
        ...
        """Postflight routine for samtools_index_bam_1_7_1 wrapper.
