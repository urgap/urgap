"""Urgap generate_experimental_design_pymx_1_0_0 wrapper."""
...
class GenerateExperimentalDesignPYMX_1_0_0(generate_experimental_design_base):
    ...
    pipeline execution. This wrapper is suited for usage with a metadata.xlsx file,
    as can be found in the untargeted metabolomics (UTMX) pipeline using the pymx
    package.
    """

    META_INFO = {
        "name": "generate_experimental_design_pymx_1_0_0",
        "version": "1.0.0",
        ...
        "input_uftypes": {
            urgap.uftypes.exp_design.input.UTMX_METADATA_XLSX: {
                "min": 1,
                "max": 1,
            },
