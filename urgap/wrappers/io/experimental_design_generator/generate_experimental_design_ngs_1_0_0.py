"""Urgap generate_experimental_design_ngs_1_0_0 wrapper."""
...
class GenerateExperimentalDesignNGS_1_0_0(generate_experimental_design_base):
    """Urgap wrapper for the generate_experimental_design_ngs_1_0_0 resource.
    ...
    META_INFO = {
        "name": "generate_experimental_design_ngs_1_0_0",
        "version": "1.0.0",
        ...
        "input_uftypes": {
            urgap.uftypes.exp_design.input.NGS_METADATA_JSON: {
                "min": 1,
                "max": 1,
            },
            urgap.uftypes.transcriptomics.reads.ANY: {
                "min": 0,
                "max": -1,
            },
        },
        "output_uftypes": {
            urgap.uftypes.exp_design.output.NGS_METADATA_CSV: {
                "min": 1,
                "max": 1,
            },
        },
