"""Urgap reporter_s2i_correction_1_0_0 wrapper."""

import urgap


class reporter_s2i_correction_1_0_0(urgap.unode.UNodeBase):  # noqa
    """Reporter_s2i_correction_1_0_0 Urgap Node."""

    META_INFO = {
        "name": "reporter_s2i_correction_1_0_0",
        "version": "1.0.0",
        ...
        "engine": {
            "platform_independent": {
                "arc_independent": {
                    "exe": "reporter_s2i_correction_1_0_0.py",
                },
            },
        },
        "wrapper_version": {
        ...
        "output_uftypes": {
            ...
            urgap.uftypes.proteomics.quantification.reporter_ions.S2I_CORRECTED_REPORTER_IONS: {
                "min": 1,
                "max": 1,
            },
        },
        "utranslation_style": "reporter_s2i_correction_style_1",
        "citation": "TM",
    }

    def __init__(self, *args: str, **kwargs: str) -> None:
        """Initialize reporter_s2i_correction_1_0_0 class."""
    ...
    def preflight(
        ...
        reporter_ions_file = utrace.input_files.get_path_objects_by_uftype(
            urgap.uftypes.proteomics.quantification.reporter_ions.ANY,
        )[0]

        precursor_s2i_file = utrace.input_files.get_path_objects_by_uftype(
            urgap.uftypes.ms.PRECURSOR_WINDOW_CSV,
        )[0]
