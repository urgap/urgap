...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            urgap.UFile(
                uri="gcs-libcloud://urgap_test?uftype={urgap.uftypes.test.TEST_FILE1}#"
        ...
        (
            urgap.UFile(
                uri="minio-libcloud://localhost:9000/data?uftype={urgap.uftypes.test.TEST_FILE1}#"
                "test_node_data/test.txt",
            ),
            urgap.URunDict(
                {
...
def test_node_workflow_rerun_is_skipped_simple(provide_clean_test_node_dirs):
    ...
    #     test_node1.remove_output_folder(output_file=output_file)
